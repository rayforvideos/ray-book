...
credentials를 사용할 때는 중요한 제약이 있습니다. `Access-Control-Allow-Origin`에 와일드카드(`*`)를 사용할 수 없습니다. 반드시 구체적인 출처를 지정해야 합니다. Allow-Methods와 Allow-Headers도 마찬가지로 와일드카드가 금지됩니다.
