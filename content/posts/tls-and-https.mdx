...
**비대칭 암호화** (Asymmetric Encryption) 는 **공개키**와 **개인키** 쌍을 사용합니다. 공개키로 암호화하면 개인키로만 복호화할 수 있습니다. RSA, ECDSA가 대표적입니다. 안전하지만 대칭 암호화보다 수백 배 느립니다.
...
const certificateChain = {
  ...
  server: {
    subject: "example.com",
    issuer: "Let's Encrypt Authority X3",  // 중간 CA가 서명
    publicKey: "서버의 공개키",
    validity: { from: "2026-01-01", to: "2026-04-01" },
  ...
  intermediate: {
    ...
    issuer: "DST Root CA X3",  // 루트 CA가 서명
  ...
  root: {
    ...
    issuer: "DST Root CA X3",  // 자체 서명 (self-signed)
