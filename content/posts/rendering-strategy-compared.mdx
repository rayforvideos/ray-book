...
[js-framework-benchmark](https://github.com/nickel-org/nickel.rs) 같은 테스트에서 Svelte가 React보다 빠른 것은 사실입니다. 하지만 벤치마크는 수천 개의 행을 동시에 업데이트하는 극단적인 시나리오입니다. 실제 애플리케이션에서 VDOM의 오버헤드가 체감되는 경우는 드뭅니다.
