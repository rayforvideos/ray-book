...
대부분의 개발자가 일상적으로 사용하는 `addEventListener`의 기본 동작은 <Term id="event-bubbling">버블링</Term> 단계에서 핸들러를 실행합니다. 하지만 캡처링 단계의 존재를 모르면, 이벤트가 예상과 다르게 동작하는 상황에서 원인을 찾기 어렵습니다.
