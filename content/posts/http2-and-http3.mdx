...
HTTP/1.1은 1997년에 표준화된 이후 오랫동안 웹의 기반이었습니다. 하지만 웹 페이지가 복잡해지면서 근본적인 한계가 드러났습니다. 하나의 TCP 연결에서 **한 번에 하나의 요청-응답**만 처리할 수 있기 때문입니다.
...
|------|----------|--------|--------|
| 표준 | RFC 2616 (1999) | RFC 7540 (2015) | RFC 9114 (2022) |
