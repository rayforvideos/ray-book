...
Node.js의 이벤트 루프는 **libuv** 라이브러리 위에 구축되어 있으며, 브라우저와 유사하지만 더 세분화되어 있습니다:
...
각 단계 사이에 마이크로태스크 큐가 비워집니다. `process.nextTick`은 마이크로태스크보다도 먼저 실행됩니다. Node.js 공식 문서 ("The Node.js Event Loop, Timers, and process.nextTick()") 에서 각 단계의 상세 동작을 확인할 수 있습니다.
